export const venues = {
  moma: {
    ...
    familyFriendly: true,
    insiderTip: `Come Friday evening — open until 8pm with notably thinner crowds than weekend afternoons. The Abby Aldrich Rockefeller Sculpture Garden (designed by Philip Johnson in 1953) is accessible from the main lobby — there's a bench facing the Rodin Balzac that's the quietest spot in Midtown if you bring a coffee.`,
  },
  met: {
    id: 'met',
    name: `The Met`,
    ...
    familyFriendly: true,
    insiderTip: `Arrive at 10am on a weekday — the second-floor European Paintings galleries are nearly empty in the first hour, and you can stand alone in front of Van Gogh and Cézanne. For the most cinematic moment in the museum, head to the Temple of Dendur in the Sackler Wing at late afternoon — the low light through the angled glass wall lights up the 2,000-year-old hieroglyphs and the reflecting pool from a single direction.`,
  },
  guggenheim: {
    id: 'guggenheim',
    name: `Guggenheim`,
  ...
  carnegie_hall: {
    ...
    familyFriendly: true,
    insiderTip: `Rush tickets go on sale at the box office on the day of the performance — excellent seats sometimes available at a fraction of the listed price. Even without a concert ticket, the public guided tour (runs most weekdays, ~60 min) takes you down to the original 1891 dressing rooms preserved as Tchaikovsky and Mahler used them — a music-history walk that doubles as architectural archaeology.`,
    weeklySchedule: [
  ...
  bronx_zoo: {
    ...
    hours: 'Apr–Oct: 10am–5pm weekdays, 10am–5:30pm weekends · Nov–Mar: 10am–4:30pm daily · last entry 45 min before close',
    ticketUrl: 'https://bronxzoo.com/shop/ticket-options',
    scheduleUrl: 'https://bronxzoo.com/plan-your-visit',
    mapUrl: 'https://maps.google.com/?q=Bronx+Zoo+2300+Southern+Blvd+Bronx',
    color: '#2d5a3d',
    accentColor: '#ffffff',
    description: `One of the largest urban zoos in the world — 265 acres along the Bronx River, run by the Wildlife Conservation Society since 1899. Not a sideshow attraction; a serious conservation institution you can walk through.`,
    character: `The Bronx Zoo opened in 1899 and remains the flagship of the Wildlife Conservation Society — the same organization doing field conservation on every continent. At 265 acres it is a full-day landscape, not an afternoon stop: Congo Gorilla Forest puts a plate of glass between you and a western lowland gorilla troop in a recreated rainforest; Tiger Mountain and JungleWorld hold the other headliners. The Beaux-Arts buildings and Rainey Memorial Gates near Fordham Road are landmarks in their own right. Paired with the New York Botanical Garden directly across Fordham Road, it makes the Bronx's strongest full-day case.`,
    specialties: ['Congo Gorilla Forest', 'Tiger Mountain', 'JungleWorld', 'Wildlife Conservation Society'],
    admissionCost: `Flex pricing: roughly $42 adults / $32 kids in season (Nov–Mar from ~$29/$21); some exhibits ticketed separately`,
    visitDuration: `Half day to full day`,
    bookingNote: `Timed tickets online; Wednesdays are free limited-admission with advance reservation`,
    familyFriendly: true,
    insiderTip: `Wednesday admission is free — but reservations open the Monday before at 5pm and go fast (4 tickets max per order). Head straight to Congo Gorilla Forest before the crowds build.`,
  },
  ny_botanical_garden: {
    id: 'ny_botanical_garden',
    name: `New York Botanical Garden`,
    fullName: 'New York Botanical Garden',
    neighborhood: 'The Bronx',
    address: '2900 Southern Blvd, Bronx, NY 10458',
    hours: 'Tue–Sun 10am–6pm (plus Monday federal holidays)',
    ticketUrl: 'https://www.nybg.org/visit/admission/',
    scheduleUrl: 'https://www.nybg.org/visit/',
    mapUrl: 'https://maps.google.com/?q=New+York+Botanical+Garden+Bronx',
    color: '#3d6b35',
    accentColor: '#ffffff',
    description: `250 acres and a National Historic Landmark — an 1891 garden built to rival Kew, with the Enid A. Haupt Conservatory as its crystal-palace centerpiece and a genuine old-growth forest at its heart.`,
    character: `The New York Botanical Garden was founded in 1891 after a Columbia botanist visited Kew Gardens and decided New York deserved the same. The Enid A. Haupt Conservatory (1902) is the finest Victorian glasshouse in America — palm dome, rainforest houses, desert rooms — and hosts the Garden's famous seasonal shows (the Orchid Show in spring, the Holiday Train Show in winter). The Thain Family Forest is the largest remnant of the old-growth forest that once covered New York City: fifty acres the loggers never reached, with the Bronx River running through a gorge below. Ride the tram once for orientation, then walk.`,
    specialties: ['Enid A. Haupt Conservatory', 'Thain Family Forest', 'Orchid Show', 'Holiday Train Show', 'Peggy Rockefeller Rose Garden'],
    admissionCost: `Grounds pass $35 weekdays / $39 weekends (conservatory + exhibitions extra); kids from $15`,
    visitDuration: `2–4 hours`,
    bookingNote: `Buy online; Wednesday grounds are free for NYC residents all day, and for everyone 10–11am`,
    familyFriendly: true,
    insiderTip: `Go on a Wednesday: grounds admission is free for NYC residents all day and for everyone from 10 to 11am. The Haupt Conservatory upgrade is the one worth paying for — especially during the Orchid Show.`,
  },
  louis_armstrong_house: {
    id: 'louis_armstrong_house',
    name: `Louis Armstrong House`,
    fullName: 'Louis Armstrong House Museum',
    neighborhood: 'Corona, Queens',
    address: '34-56 107th St, Corona, NY 11368 (visits start at the Louis Armstrong Center, 34-49 107th St)',
    hours: 'Thu–Sat 11am–4pm · house shown by guided 40-min tours on the hour (last tour 3pm)',
    ticketUrl: 'https://www.louisarmstronghouse.org/visit/',
    scheduleUrl: 'https://www.louisarmstronghouse.org/visit/',
    mapUrl: 'https://maps.google.com/?q=Louis+Armstrong+House+Museum+Corona+Queens',
    color: '#8a5a2b',
    accentColor: '#ffffff',
    description: `The modest Corona house where the most famous musician on Earth chose to live for 28 years — preserved exactly as Louis and Lucille left it, down to the gold bathroom fixtures and the den full of reel-to-reel tapes.`,
    character: `Louis Armstrong could have lived anywhere in the world. He bought a small brick house on a working-class block in Corona in 1943 and stayed until his death in 1971 — answering the door for neighborhood kids, eating at the corner Chinese restaurant, taping himself talking and playing in his den. The house is a National Historic Landmark preserved as Lucille kept it: turquoise kitchen, mirrored bathroom, the den with his tapes and trumpets. Across the street, the new Louis Armstrong Center holds the archives — 60,000 items, the largest for any jazz musician. The guided tour is 40 minutes of the most intimate musician's-house experience in America, and the block itself is the point: the world's greatest entertainer, home in Queens.`,
    specialties: ['Guided House Tours', 'Louis Armstrong Center & Archives', "Lucille's Garden", 'National Historic Landmark'],
    admissionCost: `$20 adults · $14 seniors · under 5 free`,
    visitDuration: `1–1.5 hours`,
    bookingNote: `Tours on the hour, Thu–Sat only — book ahead; groups are small`,
    familyFriendly: true,
    insiderTip: `Tours start across the street at the Louis Armstrong Center — arrive early and see the archive exhibit first, then take the 40-minute house tour. Satchmo's den, with his own tape collages playing, is the room people cry in.`,
  },
  msg: {
    id: 'msg',
  ...
  arthur_ashe_stadium: {
    ...
    ticketUrl: 'https://www.usopen.org/index.html',
    scheduleUrl: 'https://www.usopen.org/index.html',
  ...
  chrysler_building: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Chrysler_Building_by_David_Shankbone.jpg/500px-Chrysler_Building_by_David_Shankbone.jpg',
    color: '#e0f2fe',
    accentColor: '#0369a1',
  ...
  empire_state: {
    ...
    familyFriendly: true,
    insiderTip: `The 86th-floor deck at twilight — about 30 minutes after sunset — is when city lights ignite while the sky is still blue; book that specific time slot. Pro move: face north for the Chrysler Building and the long Park Avenue spine; south for One WTC and the harbor. The northwest corner gives you both with one pivot.`,
  ...
  rockefeller_center: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/30_Rockefeller_Plaza_%28Comcast_Building%29.jpg/500px-30_Rockefeller_Plaza_%28Comcast_Building%29.jpg',
    color: '#e0f2fe',
    accentColor: '#0369a1',
  ...
  woolworth_building: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Woolworth_Building_2013.jpg/500px-Woolworth_Building_2013.jpg',
    color: '#dcfce7',
    accentColor: '#15803d',
  ...
  grand_central_terminal: {
    ...
    familyFriendly: true,
    insiderTip: `Stand at the Oyster Bar entrance and whisper toward the curved tile wall — the vaulted ceiling carries sound across the room in the famous whispering gallery. Then take the stairs up to The Campbell — formerly the private apartment-office of 1920s tycoon John W. Campbell, now a cocktail bar with the original leaded glass windows and 25-foot wood-beam ceiling fully intact. Open evenings, no cover, dress smart.`,
  ...
  nypl_schwarzman: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/New_York_Public_Library_May_2011.jpg/500px-New_York_Public_Library_May_2011.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
    ...
    familyFriendly: true,
    insiderTip: `Go up to the Rose Main Reading Room on the third floor — 297 feet of gilded Renaissance ceiling in a public room that costs nothing to enter. One floor down, the Map Division (Room 117) holds 433,000 maps including hand-drawn manuscripts of 17th-century Manhattan. Anyone can request to view them — sign up for a free research card at the front desk and you're handed history.`,
  ...
  flatiron_building: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Edificio_Fuller_%28Flatiron%29_en_2010_desde_el_Empire_State_crop_boxin.jpg/500px-Edificio_Fuller_%28Flatiron%29_en_2010_desde_el_Empire_State_crop_boxin.jpg',
    color: '#dcfce7',
    accentColor: '#15803d',
  ...
  st_patricks: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/At_New_York%2C_USA_2017_119.jpg/500px-At_New_York%2C_USA_2017_119.jpg',
    color: '#f0fdf4',
    accentColor: '#166534',
  ...
  trinity_church_nyc: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Trinity_Church_Manhattan.jpg/500px-Trinity_Church_Manhattan.jpg',
    color: '#f0fdf4',
    accentColor: '#166534',
  ...
  brooklyn_bridge_arch: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Brooklyn_Bridge_Manhattan.jpg/500px-Brooklyn_Bridge_Manhattan.jpg',
    color: '#fef3c7',
    accentColor: '#b45309',
    ...
    familyFriendly: true,
    insiderTip: `Walk from Manhattan to Brooklyn — the return trip at sunset gives you the Manhattan skyline framed between the Gothic towers with the sky behind it. The wooden pedestrian walkway runs above the car lanes; stay LEFT (pedestrians) and let cyclists fly past on the right. The midpoint between the two towers (about 18 minutes in from either end) is the iconic photo angle — the cables fan symmetrically and the skyline reads cleanly on either side.`,
  ...
  seagram_building: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Seagram_Building_%2835098307116%29.jpg/500px-Seagram_Building_%2835098307116%29.jpg',
    color: '#e7e5e4',
    accentColor: '#44403c',
  ...
  lever_house: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Lever_House_390_Park_Avenue.jpg/500px-Lever_House_390_Park_Avenue.jpg',
    color: '#e7e5e4',
    accentColor: '#44403c',
  ...
  un_headquarters: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/UNheadquarters.jpg/500px-UNheadquarters.jpg',
    color: '#e7e5e4',
    accentColor: '#44403c',
  ...
  one_wtc: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/One_World_Trade_Center_on_Earth_Day_2013.jpg/500px-One_World_Trade_Center_on_Earth_Day_2013.jpg',
    color: '#f0f9ff',
    accentColor: '#0284c7',
  ...
  high_line: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/High_Line_Park%2C_Section_1a.jpg/500px-High_Line_Park%2C_Section_1a.jpg',
    color: '#f0fdf4',
    accentColor: '#15803d',
    ...
    familyFriendly: true,
    insiderTip: `Start at the Gansevoort Street entrance in the late afternoon and walk north — the Hudson is on your left and the sun sets directly over it as you walk. At 17th Street (10th Avenue Square), the wooden chaise loungers are designed to recline — claim one before sunset for the best free seat in Manhattan.`,
  ...
  shubert_theatre: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Shubert_Theatre.jpg/500px-Shubert_Theatre.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  st_james_theatre: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/St_James_Theatre_-_Frozen_%2848296062327%29.jpg/500px-St_James_Theatre_-_Frozen_%2848296062327%29.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  majestic_theatre: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Majestic_Theatre_-_NYC_%2852302522949%29.jpg/500px-Majestic_Theatre_-_NYC_%2852302522949%29.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  richard_rodgers_theatre: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Rodgers_Theater_-_Hamilton_%2848193460677%29.jpg/500px-Rodgers_Theater_-_Hamilton_%2848193460677%29.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  imperial_theatre: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/ImperialTheatreNYC.jpg/500px-ImperialTheatreNYC.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  public_theater: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/The_Public_Theater_%2848072652481%29.jpg/500px-The_Public_Theater_%2848072652481%29.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  delacorte_theater: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Shakespeare_in_the_Park_July_2021.jpg/500px-Shakespeare_in_the_Park_July_2021.jpg',
    color: '#fdf2f8',
    accentColor: '#9d174d',
  ...
  // The long-running megahits that drive Broadway tourism. Each theater here
  // is essentially defined by the one show that lives in it — Wicked at the
  // Gershwin since 2003, Lion King at the Minskoff since 2006, Chicago at
  // the Ambassador since 1996.
  gershwin_theatre: {
    id: 'gershwin_theatre',
    name: `Gershwin Theatre`,
    fullName: 'Gershwin Theatre',
    neighborhood: 'Midtown / Theatre District',
    address: '222 W 51st St, New York, NY 10019',
    hours: 'Box office Mon–Sat 10am–8pm · Sun noon–6pm',
    ticketUrl: 'https://www.wickedthemusical.com/new-york/',
    scheduleUrl: 'https://www.wickedthemusical.com/new-york/',
    mapUrl: 'https://maps.google.com/?q=Gershwin+Theatre+New+York',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Gershwin_Theatre_-_Wicked_%2854077363135%29.jpg/500px-Gershwin_Theatre_-_Wicked_%2854077363135%29.jpg',
    color: '#f0fdf4',
    accentColor: '#15803d',
    description: `Broadway's largest theater (1,933 seats) and home of Wicked since October 2003 — the second-longest-running show in Broadway history.`,
    character: `The Gershwin opened in 1972 as the Uris Theatre and was renamed in 1983 for George and Ira Gershwin. With 1,933 seats it is the largest house on Broadway by capacity. Since October 30, 2003, the Gershwin has been home to Wicked, which has become the second-longest-running Broadway production in history (behind only Phantom). The American Theater Hall of Fame is built into the mezzanine — worth a few minutes before curtain to walk the wall of inductee names.`,
    specialties: ['Wicked', 'Long-Running Musicals', 'American Theater Hall of Fame'],
    admissionCost: `$99–$300+`,
    visitDuration: `2.75 hours`,
    bookingNote: `Book ahead; daily Wicked lottery via the official app`,
    familyFriendly: true,
    insiderTip: `Even rear orchestra has solid sightlines for Wicked's flying effects — the Gershwin's wide horseshoe means there are no bad angles on the dragon clock.`,
    nowPlaying: {
      title: 'Wicked',
      tagline: 'The untold story of the witches of Oz — Stephen Schwartz musical based on Gregory Maguire\'s novel',
      through: 'Running since 2003',
      bookingUrl: 'https://www.wickedthemusical.com/new-york/',
    },
  },
  minskoff_theatre: {
    id: 'minskoff_theatre',
    name: `Minskoff Theatre`,
    fullName: 'Minskoff Theatre',
    neighborhood: 'Midtown / Theatre District',
    address: '200 W 45th St (1515 Broadway), New York, NY 10036',
    hours: 'Box office daily 10am–8pm',
    ticketUrl: 'https://www.lionking.com/',
    scheduleUrl: 'https://www.lionking.com/',
    mapUrl: 'https://maps.google.com/?q=Minskoff+Theatre+New+York',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Minskoff_Theatre_%2854076031902%29.jpg/500px-Minskoff_Theatre_%2854076031902%29.jpg',
    color: '#fff7ed',
    accentColor: '#b45309',
    description: `Home of The Lion King since 2006 — Broadway's all-time top-grossing production. 1,710 seats, three floors above Times Square.`,
    character: `The Minskoff opened in 1973 inside One Astor Plaza and sits three stories above Times Square — unusual for a Broadway house. The Lion King moved here in June 2006 from the New Amsterdam, where it had opened in 1997. Disney's production has grossed more than any other show in Broadway history and is now closing in on three decades of continuous performances. The puppetry by Julie Taymor — the giraffes, the elephant walking down the aisle in the opening number — is the most-imitated stagecraft of the last thirty years.`,
    specialties: ['The Lion King', 'Disney on Broadway', 'Puppetry'],
    admissionCost: `$99–$280+`,
    visitDuration: `2.75 hours`,
    bookingNote: `Book months ahead during school holidays`,
    familyFriendly: true,
    insiderTip: `Mezzanine front-row beats orchestra for The Lion King — you'll see the full pattern of the opening number as the animals process down the aisles to the stage.`,
    nowPlaying: {
      title: 'The Lion King',
      tagline: 'Disney\'s landmark musical with puppetry by Julie Taymor — Broadway\'s all-time top-grossing production',
      through: 'Running since 1997',
      bookingUrl: 'https://www.lionking.com/',
    },
  },
  ambassador_theatre: {
    id: 'ambassador_theatre',
    name: `Ambassador Theatre`,
    fullName: 'Ambassador Theatre',
    neighborhood: 'Midtown / Theatre District',
    address: '219 W 49th St, New York, NY 10019',
    hours: 'Box office Mon–Sat 10am–8pm · Sun noon–6pm',
    ticketUrl: 'https://chicagothemusical.com/',
    scheduleUrl: 'https://chicagothemusical.com/',
    mapUrl: 'https://maps.google.com/?q=Ambassador+Theatre+New+York',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Ambassador_Theatre_-_Chicago_%2848296059772%29.jpg/500px-Ambassador_Theatre_-_Chicago_%2848296059772%29.jpg',
    color: '#fef2f2',
    accentColor: '#dc2626',
    description: `Chicago has played here continuously since 1996 — the longest-running American musical and longest-running revival in Broadway history.`,
    character: `The Ambassador opened in 1921 and has hosted Chicago since November 1996. The Bob Fosse / John Kander / Fred Ebb musical has now run for nearly three decades in this house, making it the longest-running American musical and the longest-running revival in Broadway history. The minimalist staging — the band onstage, the dancers in black mesh — has barely changed in thirty years and remains its own argument for restraint.`,
    specialties: ['Chicago', 'Longest-Running Revival', 'Bob Fosse'],
    admissionCost: `$79–$210+`,
    visitDuration: `2.5 hours`,
    bookingNote: `Easiest big-name show to walk-in to; same-day TKTS often available`,
    familyFriendly: false,
    insiderTip: `Chicago is one of the most TKTS-friendly major shows — same-day half-price seats at the Times Square booth are reliable Tuesday through Thursday.`,
    nowPlaying: {
      title: 'Chicago',
      tagline: 'Bob Fosse / Kander & Ebb jazz musical — the longest-running American musical in Broadway history',
      through: 'Running since 1996',
      bookingUrl: 'https://chicagothemusical.com/',
    },
  },
  lyric_theatre: {
    id: 'lyric_theatre',
    name: `Lyric Theatre`,
    fullName: 'Lyric Theatre',
    neighborhood: 'Midtown / Theatre District',
    address: '213 W 42nd St, New York, NY 10036',
    hours: 'Box office Mon–Sat 10am–8pm · Sun noon–6pm',
    ticketUrl: 'https://www.harrypottertheplay.com/',
    scheduleUrl: 'https://www.harrypottertheplay.com/',
    mapUrl: 'https://maps.google.com/?q=Lyric+Theatre+42nd+Street+New+York',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Lyric_Theatre_-_Harry_Potter_and_the_Cursed_Child_%2848193409386%29.jpg/500px-Lyric_Theatre_-_Harry_Potter_and_the_Cursed_Child_%2848193409386%29.jpg',
    color: '#faf5ff',
    accentColor: '#3b0764',
    description: `Broadway's second-largest theater (1,622 seats) and the only one purpose-renovated for a single production — Harry Potter and the Cursed Child.`,
    character: `The Lyric on 42nd Street is the result of a 1998 merger of two adjacent theaters, making it Broadway's second-largest house. For Harry Potter and the Cursed Child it was rebuilt from the ground up — new lobby, transformed proscenium, custom-engineered stage tech for the show's signature illusions. The play opened in April 2018, condensed from its original two-part London staging into a single evening in 2021, and continues to run.`,
    specialties: ['Harry Potter and the Cursed Child', 'Stage Magic', 'Large-Scale Plays'],
    admissionCost: `$99–$299+`,
    visitDuration: `3.5 hours`,
    bookingNote: `Book ahead; Friday Forty lottery offers $40 tickets weekly`,
    familyFriendly: true,
    insiderTip: `The Friday Forty lottery (entered weekly on the show's site) drops 40 premium-section seats for $40 each — best lottery odds of any major show.`,
    nowPlaying: {
      title: 'Harry Potter and the Cursed Child',
      tagline: 'The eighth Harry Potter story, staged with the most ambitious illusions on Broadway — by Jack Thorne',
      through: 'Running since 2018',
      bookingUrl: 'https://www.harrypottertheplay.com/',
    },
  },
  winter_garden_theatre: {
    id: 'winter_garden_theatre',
    name: `Winter Garden Theatre`,
    fullName: 'Winter Garden Theatre',
    neighborhood: 'Midtown / Theatre District',
    address: '1634 Broadway at 50th St, New York, NY 10019',
    hours: 'Box office Mon–Sat 10am–8pm · Sun noon–6pm',
    ticketUrl: 'https://www.backtothefuturemusical.com/new-york/',
    scheduleUrl: 'https://www.backtothefuturemusical.com/new-york/',
    mapUrl: 'https://maps.google.com/?q=Winter+Garden+Theatre+New+York',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Back_To_the_Future-_The_Musical_at_the_Winter_Garden_Theatre%2C_August_2023%2C_night.jpg/500px-Back_To_the_Future-_The_Musical_at_the_Winter_Garden_Theatre%2C_August_2023%2C_night.jpg',
    color: '#fef3c7',
    accentColor: '#7c2d12',
    description: `1,500-seat house where Cats ran for 18 years, Mamma Mia for 13, and Back to the Future has been parked since August 2023.`,
    character: `The Winter Garden has been the home of Broadway's most physically ambitious productions for a century. Cats ran here for 7,485 performances starting in 1982 — the second-longest run in Broadway history when it closed. Mamma Mia followed for thirteen years. Since August 2023 it's housed Back to the Future, with a full-size flying DeLorean as its centerpiece illusion. The stage depth is among the largest on Broadway — the reason productions that need to fly cars, trains, or chandeliers tend to land here.`,
    specialties: ['Back to the Future', 'Large-Scale Spectacle', 'Stage Engineering'],
    admissionCost: `$89–$275+`,
    visitDuration: `2.75 hours`,
    bookingNote: `Book mid-week for better odds and softer pricing`,
    familyFriendly: true,
    insiderTip: `The Winter Garden has the deepest stage of any pre-1930s Broadway house — that's why every big-spectacle show with flying tech ends up here.`,
    nowPlaying: {
      title: 'Back to the Future: The Musical',
      tagline: 'Marty McFly and Doc Brown adapted for the stage with a full-size flying DeLorean — book by Bob Gale, the original screenwriter',
      through: 'Running since 2023',
      bookingUrl: 'https://www.backtothefuturemusical.com/new-york/',
    },
  },
  eugene_oneill_theatre: {
    id: 'eugene_oneill_theatre',
    name: `Eugene O'Neill Theatre`,
    fullName: 'Eugene O\'Neill Theatre',
    neighborhood: 'Midtown / Theatre District',
    address: '230 W 49th St, New York, NY 10019',
    hours: 'Box office Mon–Sat 10am–8pm · Sun noon–6pm',
    ticketUrl: 'https://bookofmormonbroadway.com/',
    scheduleUrl: 'https://bookofmormonbroadway.com/',
    mapUrl: 'https://maps.google.com/?q=Eugene+ONeill+Theatre+New+York',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Book_of_Mormon_%40_Eugene_ONeill_Theatre_on_Broadway.jpg/500px-Book_of_Mormon_%40_Eugene_ONeill_Theatre_on_Broadway.jpg',
    color: '#eff6ff',
    accentColor: '#1e40af',
    description: `Home of The Book of Mormon since 2011 — Trey Parker and Matt Stone's nine-Tony-winning musical that still books months out.`,
    character: `The Eugene O'Neill opened in 1925 and was renamed in 1959 for the playwright Eugene O'Neill, who had died in 1953. Since March 2011 it has housed The Book of Mormon, the Trey Parker / Matt Stone / Robert Lopez musical that won nine Tony Awards in its debut season. Fourteen years in, it still sells out most performances. The theater seats 1,108, which is small enough that any seat in the house feels close to the action.`,
    specialties: ['The Book of Mormon', 'Comedy Musicals', 'Mid-Sized Broadway House'],
    admissionCost: `$89–$250+`,
    visitDuration: `2.5 hours`,
    bookingNote: `Book a month ahead; in-person lottery 2.5 hours before curtain`,
    familyFriendly: false,
    insiderTip: `The Book of Mormon's in-person lottery runs 2.5 hours before each show at the theater — front-row seats for $32, drawn from a paper-slip bucket. Best odds for evening shows mid-week.`,
    nowPlaying: {
      title: 'The Book of Mormon',
      tagline: 'Trey Parker, Matt Stone, and Robert Lopez\'s nine-Tony-winning musical about two missionaries in Uganda',
      through: 'Running since 2011',
      bookingUrl: 'https://bookofmormonbroadway.com/',
    },
  },
  ...
  federal_hall: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Federal_Hall_%2848126566178%29.jpg/500px-Federal_Hall_%2848126566178%29.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  fraunces_tavern: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Frauncestavern.JPG/500px-Frauncestavern.JPG',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  african_burial_ground: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/African_Burial_Ground.jpg/500px-African_Burial_Ground.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  ellis_island: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Aerial_view_of_Ellis_Island%2C_Jersey_City%2C_New_Jersey_LCCN2011635626_-_cropped_balance.jpg/500px-Aerial_view_of_Ellis_Island%2C_Jersey_City%2C_New_Jersey_LCCN2011635626_-_cropped_balance.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  tenement_museum: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Tenement_Museum_exterior_4.jpg/500px-Tenement_Museum_exterior_4.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  stonewall_inn: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Stonewall_Inn_5_pride_weekend_2016.jpg/500px-Stonewall_Inn_5_pride_weekend_2016.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  hamilton_grange: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Hamilton_Grange_National_Memorial_-_Entrance_%2848170424452%29.jpg/500px-Hamilton_Grange_National_Memorial_-_Entrance_%2848170424452%29.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  schomburg_center: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Schomburg_Center_for_Research_in_Black_Culture_%2852008381132%29.jpg/500px-Schomburg_Center_for_Research_in_Black_Culture_%2852008381132%29.jpg',
    color: '#fef9c3',
    accentColor: '#a16207',
  ...
  central_park: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Bethesda_Fountain_Central_Park.jpg/500px-Bethesda_Fountain_Central_Park.jpg',
    color: '#f0fdf4',
    accentColor: '#15803d',
    ...
    bookingNote: `No booking needed`,
    familyFriendly: true,
    insiderTip: `Central Park is 843 acres — the trick is going to the right corner for what you actually want.

📷 Want the lake view? Bow Bridge at the south end of The Lake (mid-park, ~74th St) is the iconic shot — western skyline framed between two elms. Plenty of benches along the surrounding path and Cherry Hill just above it; bridge is empty before 9am or after dusk.

👨‍👩‍👧 Bringing kids? Sheep Meadow (15-acre open lawn near 66th St) is the city's biggest unobstructed grass — kick a ball, throw a frisbee, picnic without dodging anyone. Heckscher Playground (south side, near the Columbus Circle entrance) is the largest of the park's 21 playgrounds.

🐦 Birding or just wandering? The Ramble — a 36-acre wild woodland in the center — is one of the best urban birding spots in North America. Over 200 species pass through in spring migration.

🏛 Iconic photos? Bethesda Terrace (the angel fountain at the bottom of the staircase, mid-park at 72nd St) is the most-filmed location in any NYC park.

📚 Quiet escape from tourists? The Pool (far north end, near W 100th St) is where locals actually go to read.`,
    priceNote: `Free`,
  },
  ...
  intrepid_museum: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Intrepid_Sea-Air-Space_Museum.jpg/500px-Intrepid_Sea-Air-Space_Museum.jpg',
    color: '#eff6ff',
    accentColor: '#1d4ed8',
  ...
  bryant_park: {
    id: 'bryant_park',
    name: `Bryant Park`,
    fullName: 'Bryant Park',
    neighborhood: 'Midtown',
    address: '40th-42nd St & 5th-6th Ave, New York, NY 10018',
    hours: '7am – 10pm (varies seasonally)',
    ticketUrl: 'https://bryantpark.org/',
    scheduleUrl: 'https://bryantpark.org/programs',
    mapUrl: 'https://maps.google.com/?q=Bryant+Park+New+York',
    imageUrl: '',
    color: '#f0fdf4',
    accentColor: '#15803d',
    description: `A 9.6-acre Midtown oasis behind the NY Public Library — the most European-feeling public park in NYC, with moveable green chairs you arrange yourself.`,
    character: `Bryant Park is the antithesis of the busy Midtown streets that surround it. Hundreds of moveable green metal chairs and bistro tables sit on a central lawn ringed by London plane trees, all framed by the Beaux-Arts back of the NY Public Library. Designed in the 1930s and renovated in the 1990s, the park hosts a free reading room, summer movies on the lawn, an ice rink in winter, and the Bryant Park Grill restaurant overlooking it all. The lack of fences and the abundance of unattached chairs makes it function like an outdoor cafe even though there's no entrance fee.`,
    specialties: ['Park', 'Outdoor seating', 'Free wifi', 'Reading room', 'Seasonal events'],
    admissionCost: `Free`,
    visitDuration: `30 min – 2 hours`,
    bookingNote: `Walk-in anytime`,
    familyFriendly: true,
    insiderTip: `The reading room (May–Oct, near the 42nd St side) lets you check out books and magazines on the spot — no library card needed. Winter Village (Oct–Mar) brings free ice skating (BYO skates costs nothing).`,
  },
  ...
  washington_square_park: {
    ...
    ticketUrl: '',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Washington+Square+Park',
    imageUrl: '',
    color: '#fefce8',
    accentColor: '#a16207',
    description: `The marble arch, the central fountain, the chess players, the buskers, the NYU students — Washington Square is the closest thing NYC has to a town square.`,
    character: `The 1892 marble Washington Arch (designed by Stanford White, inspired by Paris's Arc de Triomphe) anchors a 9.75-acre park that's been Manhattan's bohemian living room since the 19th century. Dustin Hoffman ran through it in The Graduate; Bob Dylan posed near the arch on the cover of The Freewheelin'; the chess tables on the southwest corner have hosted speed games since the 1950s. The central fountain runs from May through October, and the steps around it become bleacher seating for the buskers, breakdancers, and impromptu jazz combos that perform daily.`,
    specialties: ['Park', 'Live performance', 'People-watching', 'Architecture'],
    admissionCost: `Free`,
    visitDuration: `45 min – 2 hours`,
    bookingNote: `Walk-in anytime`,
    familyFriendly: true,
    insiderTip: `The chess tables on the southwest corner welcome visitors — bring $5 if you want to play a regular, or just watch the speed games. Sunday afternoon is when the fountain area hits peak energy, with multiple buskers competing for the crowd.`,
  },

  battery_park: {
    id: 'battery_park',
    name: `Battery Park`,
    fullName: 'The Battery',
    neighborhood: 'Financial District',
    address: 'State St & Battery Pl, New York, NY 10004',
    hours: '6am – 1am',
    ticketUrl: '',
    scheduleUrl: 'https://thebattery.org/events/',
    mapUrl: 'https://maps.google.com/?q=Battery+Park+New+York',
    imageUrl: '',
    color: '#f0f9ff',
    accentColor: '#0369a1',
    description: `The 25-acre park at the southern tip of Manhattan, with the Statue of Liberty on the horizon and the entry point for ferries to Liberty and Ellis Islands.`,
    character: `Battery Park sits at the literal end of Manhattan, where the island narrows to a point and meets New York Harbor. The Statue of Liberty stands on Liberty Island a mile offshore — visible from anywhere along the park's promenade. Castle Clinton (a circular sandstone fort from 1811) sits in the middle of the park; it served as the immigration depot before Ellis Island opened in 1892, processing 8 million arrivals. The Sphere — a bronze sculpture salvaged from the World Trade Center plaza — now sits here as a 9/11 memorial. Ferries to Liberty + Ellis Islands leave from the dock at the park's south end.`,
    specialties: ['Park', 'Harbor views', 'Statue of Liberty', 'Historical site'],
    admissionCost: `Free (Liberty/Ellis ferry tickets sold separately)`,
    visitDuration: `1–2 hours`,
    bookingNote: `Walk-in for the park itself; ferries to Liberty/Ellis Islands require advance booking`,
    familyFriendly: true,
    insiderTip: `The free Staten Island Ferry from Whitehall Terminal (3 blocks east) gives you the Statue of Liberty view at zero cost — much better than the paid harbor cruises. Castle Clinton itself is free to enter, with rotating exhibits inside.`,
  },

  amnh: {
    id: 'amnh',
    name: `AMNH`,
    fullName: 'American Museum of Natural History',
    neighborhood: 'Upper West Side',
    address: '200 Central Park West, New York, NY 10024',
    hours: 'Daily 10am – 5:30pm',
    ticketUrl: 'https://www.amnh.org/visit/buy-tickets',
    scheduleUrl: 'https://www.amnh.org/calendar',
    mapUrl: 'https://maps.google.com/?q=American+Museum+of+Natural+History',
    imageUrl: '',
    color: '#fef3c7',
    accentColor: '#92400e',
    description: `45 permanent exhibition halls across four city blocks — dinosaurs, the Hayden Planetarium, the blue whale, and the Hall of Ocean Life. NYC's family-day default for a reason.`,
    character: `AMNH was founded in 1869 and now occupies a 27-building complex on Central Park West that contains 33+ million artifacts. The Fossil Halls (4th floor) are the headline — the T. rex and the towering Apatosaurus skeletons have been on display since 1905. The Hayden Planetarium (inside the Rose Center for Earth and Space) projects star shows narrated by Neil deGrasse Tyson on a 67-foot dome. The 94-foot fiberglass blue whale suspended over the Hall of Ocean Life has been a landmark in its own right since 1969 — every NYC kid has stood under it. The 2023 Richard Gilder Center addition (Studio Gang's swooping concrete cavern) is the newest highlight.`,
    specialties: ['Natural history', 'Family-friendly', 'Planetarium', 'Dinosaurs', 'Interactive exhibits'],
    figureIds: [],
    admissionCost: `$28 adults · $16 children · suggested but discretionary at the door for NY/NJ/CT residents`,
    visitDuration: `3–5 hours (easily a full day)`,
    bookingNote: `Pre-book timed tickets at amnh.org during peak weekends; walk-up usually fine weekdays`,
    familyFriendly: true,
    insiderTip: `NY/NJ/CT residents can pay what they wish at the in-person ticket counter (skip the online booking — bring ID). The Hayden Planetarium space show is the hidden highlight; book it as a timed add-on. Enter from the Columbus Ave side to avoid the longer Central Park West entry line on weekends.`,
  },

  the_campbell: {
    id: 'the_campbell',
    name: `The Campbell`,
    fullName: 'The Campbell (Grand Central Terminal)',
    neighborhood: 'Midtown East',
    address: '15 Vanderbilt Ave, New York, NY 10017 (inside Grand Central)',
    hours: 'Daily 4pm – midnight',
    ticketUrl: '',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=The+Campbell+Grand+Central',
    imageUrl: '',
    color: '#1c1917',
    accentColor: '#d4a843',
    description: `Cocktail bar hidden in plain sight inside Grand Central — the restored 1920s private office of tycoon John W. Campbell, with 25-foot wood-beam ceiling and leaded glass windows preserved.`,
    character: `John W. Campbell rented the second-floor space above what is now the Oyster Bar in 1923 and turned it into a private apartment-office in the style of a 13th-century Florentine palazzo. He used it as his daytime office and entertaining space for guests including the New York Central Railroad executives downstairs. After his death in 1957 the space became a closet, then a transit police office, then was restored to its 1923 glory and reopened as a cocktail bar in 1999. The 25-foot hand-painted plaster ceiling, the leaded glass windows facing 43rd Street, and the original carved oak — all preserved.`,
    specialties: ['Cocktail bar', 'Hidden gem', 'Historic interior', 'Date night'],
    admissionCost: `No cover · cocktails $20–25`,
    visitDuration: `1–2 hours`,
    bookingNote: `Walk-in for the bar; reservations available for the salon room (Resy)`,
    familyFriendly: false,
    insiderTip: `The entrance is hidden behind an unmarked door off the southwest corner of Vanderbilt Hall — take the stairs marked "The Campbell" near the Vanderbilt Avenue entrance, not through the main concourse. Smart-casual dress code enforced. Order the gin-based Prohibition Punch — it's the bar's signature.`,
    isRestaurant: true,
    cuisine: 'Bar', price: 3,
    meals: ['dinner', 'late_night'],
    vibe: ['date_night', 'iconic', 'hidden_gem'],
    bookingDifficulty: 'easy',
    bookingUrl: '',
    mustOrder: ['Prohibition Punch', 'Old Fashioned'],
  },

  // ── Date-night dinner anchors ──
  carbone: {
    id: 'carbone',
    name: `Carbone`,
    fullName: 'Carbone',
    ...
    hours: 'Mon–Sat 5:30pm – midnight · Closed Sun',
    ticketUrl: 'https://www.carbonenewyork.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Carbone+New+York',
    imageUrl: '',
    color: '#7f1d1d',
    accentColor: '#7f1d1d',
    description: `Major Food Group's red-sauce temple — captains in burgundy tuxedos, $35 spicy rigatoni, the hardest reservation in NYC.`,
    character: `Carbone opened in 2013 in the old Rocco's space on Thompson Street and immediately became the platonic ideal of a New York Italian-American restaurant. Captains in burgundy Zac Posen tuxedos tableside-toss caesar salads, the spicy rigatoni vodka is the most photographed pasta in NYC, and the bread basket alone (whipped ricotta + garlic knots + soppressata) is worth the visit. Reservations open exactly 30 days out at 10am on Resy and disappear in under 60 seconds.`,
    specialties: ['Italian-American', 'Date night', 'Hard-to-book'],
    admissionCost: `$$$$ — expect $150–250/person with drinks`,
    visitDuration: `2 hours`,
    bookingNote: `Resy 30 days out at 10am sharp. Walk-ins occasionally seated at the bar.`,
    familyFriendly: false,
    insiderTip: `Bar seats are first-come walk-in and serve the full menu — show up 5pm for a chance. If you score the dining room, order the spicy rigatoni vodka (worth the hype) plus the veal parm (the actual standout).`,
    // Restaurant-specific fields (drive the Eat mood + filters)
    isRestaurant: true,
    cuisine: 'Italian',
    price: 4,
    meals: ['dinner'],
    vibe: ['date_night', 'iconic', 'splurge'],
    dietary: ['vegetarian'], // pastas/antipasti make a real vegetarian meal easy
    bookingDifficulty: 'impossible',
  ...
  don_angie: {
    ...
    ticketUrl: 'https://donangie.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Don+Angie+New+York',
    imageUrl: '',
    color: '#9d174d',
    accentColor: '#9d174d',
    description: `Italian-American with a creative streak — the lasagna-for-two and the chrysanthemum salad are the dishes people Instagram and then dream about.`,
    character: `Husband-wife team Scott Tacinelli and Angie Rito opened Don Angie in 2017 and reinvented what a date-night Italian in New York could be. The pinwheel lasagna ($46, for two) is iconic — slices of pasta rolled like a flower, then crisped on the outside. The chrysanthemum salad is the showpiece appetizer. The Art Deco interior with mirrored ceilings and pink banquettes feels like it was designed specifically for proposing in.`,
    specialties: ['Italian-American', 'Date night', 'Pasta'],
    admissionCost: `$$$ — $90–130/person`,
    visitDuration: `2 hours`,
    bookingNote: `Resy 30 days out. Bar seats walk-in.`,
    familyFriendly: false,
    insiderTip: `The pinwheel lasagna and chrysanthemum salad are the must-orders — split both with whoever you're with. The bar serves the full menu and is the move if you didn't get a table.`,
    isRestaurant: true,
    cuisine: 'Italian',
    price: 3,
    meals: ['dinner'],
    vibe: ['date_night', 'iconic'],
    dietary: ['vegetarian'],
    bookingDifficulty: 'hard',
    bookingUrl: 'https://resy.com/cities/ny/don-angie',
    mustOrder: ['Pinwheel lasagna for two', 'Chrysanthemum salad'],
  },

  // ── Restaurant database — Eat mood picks ──
  joes_pizza: {
    id: 'joes_pizza',
    name: `Joe's Pizza`,
    fullName: "Joe's Pizza of Bleecker Street",
    neighborhood: 'Greenwich Village',
    address: '7 Carmine St, New York, NY 10014',
    hours: 'Daily 10am – 4am',
    ticketUrl: '',
    scheduleUrl: '',
    mapUrl: "https://maps.google.com/?q=Joe's+Pizza+Carmine+NYC",
    imageUrl: '',
    color: '#dc2626', accentColor: '#dc2626',
    description: `The platonic NYC slice — thin, foldable, $3.75, open until 4am, on the corner of Bleecker and Carmine since 1975.`,
    character: `Joe Pozzuoli opened Joe's in 1975 on the corner of Bleecker and 7th Ave South (the original storefront, now closed; this Carmine St location is the spiritual successor). The slice is the New York standard against which every other slice is measured: thin enough to fold in half, slightly charred on the bottom, with restraint on the cheese. Spider-Man movies have filmed here.`,
    specialties: ['Pizza by the slice', 'Late night', 'Walk-in'],
    admissionCost: `$3.75/slice`,
    visitDuration: `15 min`,
    bookingNote: `Walk-in only, no seating beyond the counter`,
    familyFriendly: true,
    insiderTip: `Order the plain cheese — the canonical slice. The corner takeout window is faster than the inside line. If you have time, order it "well done" and wait 2 extra minutes for the bottom to crisp.`,
    isRestaurant: true,
    cuisine: 'Pizza', price: 1,
    meals: ['lunch', 'dinner', 'late_night'],
    vibe: ['iconic', 'casual', 'quick', 'family_friendly'],
    dietary: ['vegetarian'],
    bookingDifficulty: 'walk-in',
    bookingUrl: '',
    mustOrder: ['Plain cheese slice', 'Pepperoni'],
  },
  ...
  lucali: {
    ...
    hours: 'Wed–Mon 5pm – 10pm · Closed Tue',
    ticketUrl: '',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Lucali+Brooklyn',
    imageUrl: '',
    color: '#7f1d1d', accentColor: '#7f1d1d',
    description: `Mark Iacono's pizza in a candlelit former Carroll Gardens candy shop — many call it the best pie in NYC.`,
    character: `Mark Iacono opened Lucali in 2006 in the former Iacono family candy shop on Henry Street. The menu is two items: pizza and calzone. The dough is hand-rolled, the oven is wood-fired, the dining room is lit entirely by candles. It is consistently named the best pizza in NYC by every food critic who tries it. BYOB.`,
    specialties: ['Wood-fired pizza', 'Date night', 'BYOB'],
    admissionCost: `$$ — pizza ~$30, calzone ~$25`,
    visitDuration: `1.5 hours`,
    bookingNote: `Walk-in only, no reservations. Line forms by 5pm; expect 1-2 hour wait on weekends.`,
    familyFriendly: false,
    insiderTip: `Line up by 4:45pm on weekends or come Tuesday-Wednesday after 8pm for the shortest wait. They're BYOB — stop at Smith Street Liquors on your way. Order one pizza per two people (don't overdo it) and add basil + soppressata.`,
    isRestaurant: true,
    cuisine: 'Pizza', price: 2,
    meals: ['dinner'],
    vibe: ['date_night', 'iconic', 'hidden_gem', 'family_friendly'],
    dietary: ['vegetarian'],
    bookingDifficulty: 'hard',
    bookingUrl: '',
    mustOrder: ['Pizza with basil + soppressata', 'Calzone'],
  },
  ...
  lilia: {
    ...
    hours: 'Mon–Sat 5:30pm – 11pm · Closed Sun',
    ticketUrl: 'https://www.lilianewyork.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Lilia+Williamsburg',
    imageUrl: '',
    color: '#9d174d', accentColor: '#9d174d',
    description: `Missy Robbins's handmade-pasta temple in a converted Williamsburg auto-body shop — the agnolotti are the dish that built her name.`,
    character: `Missy Robbins opened Lilia in 2016 in a converted auto-body shop in Williamsburg and rapidly became the pasta restaurant other chefs in NYC respect most. The mafaldini with pink peppercorns and the agnolotti are the iconic dishes. Whitewashed walls, wide bar, the chef sometimes visible in the open kitchen.`,
    specialties: ['Italian', 'Handmade pasta', 'Date night'],
    admissionCost: `$$$ — $90–130/person`,
    visitDuration: `2 hours`,
    bookingNote: `Resy opens 30 days out; books up fast. Walk-in bar seats sometimes available 5:30pm sharp.`,
    familyFriendly: false,
    insiderTip: `Get the agnolotti and the mafaldini — both, no negotiation. The bar serves the full menu and is the move if you don't have a reservation; arrive right at 5:30pm opening for a chance at a seat.`,
    isRestaurant: true,
    cuisine: 'Italian', price: 3,
    meals: ['dinner'],
    vibe: ['date_night', 'iconic'],
    dietary: ['vegetarian'],
    bookingDifficulty: 'hard',
    bookingUrl: 'https://resy.com/cities/ny/lilia',
    mustOrder: ['Agnolotti', 'Mafaldini with pink peppercorns', 'Sheep\'s milk cheese-filled agnolotti'],
  },

  sushi_nakazawa: {
    id: 'sushi_nakazawa',
    name: `Sushi Nakazawa`,
    fullName: 'Sushi Nakazawa',
    neighborhood: 'West Village',
    address: '23 Commerce St, New York, NY 10014',
    hours: 'Daily 5pm – 10:30pm',
    ticketUrl: 'https://www.sushinakazawa.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Sushi+Nakazawa',
    imageUrl: '',
    color: '#1c1917', accentColor: '#1c1917',
    description: `Daisuke Nakazawa (apprentice to Jiro of Jiro Dreams of Sushi) serves a 20-course omakase that's NYC's highest-rated sushi experience.`,
    character: `Chef Daisuke Nakazawa trained for 11 years under Jiro Ono of Sukiyabashi Jiro in Tokyo before opening this West Village omakase counter in 2013. The 20-course tasting (~$180 sushi bar / $150 dining room) moves at the pace Nakazawa sets — sometimes 90 minutes, sometimes 2 hours. NYT 4-star review on opening; still the standard.`,
    specialties: ['Sushi', 'Omakase', 'Date night', 'Tasting menu'],
    admissionCost: `$$$$ — $180 sushi bar, $150 dining room`,
    visitDuration: `1.5–2 hours`,
    bookingNote: `Resy 30 days out, sells out quickly. Sushi bar seats prioritized over dining room.`,
    familyFriendly: false,
    insiderTip: `Sushi bar > dining room — you watch Nakazawa-san prepare each piece in front of you. Arrive 10 minutes early; they start exactly on the dot. No menu, no choices — eat what's served, in the order served.`,
    isRestaurant: true,
    cuisine: 'Sushi', price: 4,
    meals: ['dinner'],
    vibe: ['date_night', 'splurge', 'iconic'],
    bookingDifficulty: 'hard',
    bookingUrl: 'https://resy.com/cities/ny/sushi-nakazawa',
    mustOrder: ['20-course omakase (no other options)'],
  },
  ...
  atomix: {
    ...
    ticketUrl: 'https://www.atomixnyc.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Atomix+New+York',
    imageUrl: '',
    color: '#1c1917', accentColor: '#f59e0b',
    description: `Junghyun Park's 10-course modern Korean tasting menu — three Michelin stars, the highest-rated restaurant in NYC.`,
    character: `Chef Junghyun "JP" Park opened Atomix in 2018 and within five years had three Michelin stars and the #1 spot on the World's 50 Best Restaurants list. The 10-course tasting reinterprets Korean tradition through modern technique — each course arrives with a printed card explaining the dish and its history. 14 seats around a wood counter.`,
    specialties: ['Korean', 'Tasting menu', 'Splurge', 'Three Michelin stars'],
    admissionCost: `$$$$ — $295/person + $195 wine pairing`,
    visitDuration: `2.5–3 hours`,
    bookingNote: `Tock reservations open 60 days out at noon, sell out in under 5 minutes.`,
    familyFriendly: false,
    insiderTip: `Set a Tock calendar alert for 60 days before your target date — these reservations move faster than Hamilton tickets. If Atomix is impossible, the same team runs Atoboy (more accessible, much cheaper) and Naro (Hudson Yards). All three are excellent.`,
    isRestaurant: true,
    cuisine: 'Korean', price: 4,
    meals: ['dinner'],
    vibe: ['date_night', 'splurge', 'iconic'],
    bookingDifficulty: 'impossible',
    bookingUrl: 'https://www.exploretock.com/atomixnyc',
    mustOrder: ['10-course tasting menu (no other options)'],
  },

  peter_luger: {
    id: 'peter_luger',
    name: `Peter Luger Steak House`,
    fullName: 'Peter Luger Steak House',
    neighborhood: 'Williamsburg',
    address: '178 Broadway, Brooklyn, NY 11211',
    hours: 'Daily 11:45am – 10pm',
    ticketUrl: 'https://peterluger.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Peter+Luger',
    imageUrl: '',
    color: '#7f1d1d', accentColor: '#7f1d1d',
    description: `Brooklyn's 137-year-old porterhouse temple — beer-hall interior, no menu, just steak. The original NYC steakhouse.`,
    character: `Peter Luger opened in 1887 in the German neighborhood of Williamsburg and has been serving the same porterhouse-for-two ever since. No menu — the server tells you what's on offer (it's steak). The dry-aged porterhouse is the entire experience: 32-day aged, served sliced with the bone, sizzling in beef fat. Cash only until 2024, when they finally added card acceptance.`,
    specialties: ['Steakhouse', 'Porterhouse', 'Iconic'],
    admissionCost: `$$$$ — porterhouse for 2 ~$140`,
    visitDuration: `2 hours`,
    bookingNote: `Resy reservations open 30 days out; lunch easier than dinner. Walk-in possible weekday lunch.`,
    familyFriendly: true,
    insiderTip: `Lunch is the smart play: same steak, half the wait, easier reservation, and the burger (lunch-only) is one of the best in NYC at $20. Order the porterhouse for two + creamed spinach + thick-cut bacon as starter. Skip dessert — go to Peter Pan Donut in nearby Greenpoint instead.`,
    isRestaurant: true,
    cuisine: 'Steakhouse', price: 4,
    meals: ['lunch', 'dinner'],
    vibe: ['iconic', 'date_night', 'splurge'],
    bookingDifficulty: 'hard',
    bookingUrl: 'https://resy.com/cities/ny/peter-luger',
    mustOrder: ['Porterhouse for two', 'Lunch burger', 'Creamed spinach', 'Thick-cut bacon'],
  },

  le_bernardin: {
    id: 'le_bernardin',
    name: `Le Bernardin`,
    fullName: 'Le Bernardin',
    neighborhood: 'Midtown',
    address: '155 W 51st St, New York, NY 10019',
    hours: 'Mon–Fri 12pm – 2:30pm + 5:15pm – 10:30pm · Sat dinner only · Closed Sun',
    ticketUrl: 'https://www.le-bernardin.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Le+Bernardin',
    imageUrl: '',
    color: '#0c4a6e', accentColor: '#0c4a6e',
    description: `Eric Ripert's three-Michelin-star French seafood institution — fish so good it's been NYT-4-starred for 38 consecutive years.`,
    character: `Le Bernardin opened in 1986 and has held the New York Times's 4-star rating continuously since — the longest run of any restaurant in the city. Chef Eric Ripert specializes in seafood prepared with French technique: barely-cooked, intensely seasoned, with sauces that have inspired a generation of chefs. The dining room is hushed, the service is European-formal, the tasting menu is the move.`,
    specialties: ['French', 'Seafood', 'Tasting menu', 'Three Michelin stars'],
    admissionCost: `$$$$ — $245 prix fixe / $325 tasting`,
    visitDuration: `2.5 hours`,
    bookingNote: `OpenTable 30 days out at midnight. Lunch prix fixe ($95) is the most accessible entry.`,
    familyFriendly: false,
    insiderTip: `Lunch prix fixe ($95, three courses) is the way to experience Le Bernardin without the $325 dinner commitment. Order the Yellowfin Tuna Carpaccio + any "Lightly Cooked" fish — Ripert's mastery shows there. Dress code is jacket required for dinner.`,
    isRestaurant: true,
    cuisine: 'French', price: 4,
    meals: ['lunch', 'dinner'],
    vibe: ['date_night', 'splurge', 'iconic'],
    dietary: ['vegetarian'], // offers a dedicated vegetarian tasting menu
    bookingDifficulty: 'hard',
    bookingUrl: 'https://www.opentable.com/le-bernardin',
    mustOrder: ['Yellowfin tuna carpaccio', 'Lightly cooked black bass', 'Chocolate dessert tasting'],
  },
  ...
  cosme: {
    ...
    ticketUrl: 'https://cosmenyc.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Cosme+New+York',
    imageUrl: '',
    color: '#92400e', accentColor: '#92400e',
    description: `Enrique Olvera's modern Mexican restaurant — the husk meringue with corn mousse is the most photographed dessert in NYC.`,
    character: `Mexican chef Enrique Olvera (of Pujol in Mexico City) opened Cosme in 2014 and reset what New York thought modern Mexican could be. The duck carnitas (for the table) is the headline savory dish; the husk meringue with corn mousse is iconic enough to have its own Wikipedia entry. The dining room is industrial-modern; the wine list focuses on natural Mexican wines.`,
    specialties: ['Mexican', 'Modern', 'Date night'],
    admissionCost: `$$$$ — $100–150/person`,
    visitDuration: `2 hours`,
    bookingNote: `Resy 30 days out. Bar seats walk-in.`,
    familyFriendly: false,
    insiderTip: `Order the duck carnitas (for the whole table — it serves 2-4) and the husk meringue dessert. Don't skip the mezcal flight at the bar before sitting. Walk-in at the bar usually works on weeknights.`,
    isRestaurant: true,
    cuisine: 'Mexican', price: 4,
    meals: ['dinner'],
    vibe: ['date_night', 'iconic'],
    dietary: ['vegetarian', 'gluten_free'], // corn-masa-centric kitchen; several veg plates
    bookingDifficulty: 'hard',
    bookingUrl: 'https://resy.com/cities/ny/cosme',
    mustOrder: ['Duck carnitas (for the table)', 'Husk meringue', 'Tuna tostada'],
  },

  russ_and_daughters_cafe: {
    id: 'russ_and_daughters_cafe',
    name: `Russ & Daughters Cafe`,
    fullName: 'Russ & Daughters Cafe',
    neighborhood: 'Lower East Side',
    address: '127 Orchard St, New York, NY 10002',
    hours: 'Daily 9am – 4pm',
    ticketUrl: 'https://www.russanddaughterscafe.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Russ+and+Daughters+Cafe',
    imageUrl: '',
    color: '#0e7490', accentColor: '#0e7490',
    description: `The sit-down cafe spin-off of the 1914 appetizing shop down the street — the canonical NYC bagel + lox + smoked fish brunch.`,
    character: `The Russ family opened the original Russ & Daughters appetizing shop at 179 East Houston Street in 1914 — still operating today as a counter-service legend. The Cafe (2014, half a mile south on Orchard) is the family's sit-down restaurant version, serving the same smoked fish on actual plates with actual cocktails. The Classic Board (your choice of fish + bagel + accompaniments) is the move.`,
    specialties: ['Jewish appetizing', 'Brunch', 'Bagels', 'Smoked fish'],
    admissionCost: `$$ — $25-40/person`,
    visitDuration: `1 hour`,
    bookingNote: `Resy taken; walk-in usually 30-60 min wait on weekend mornings.`,
    familyFriendly: true,
    insiderTip: `If the wait is long, walk one block to Russ & Daughters Bagels & Bialys (149 1st Ave) — same fish, takeout only, walk right up. The Cafe's egg cream is a real one with U-Bet syrup. Order the Super Heebster bagel.`,
    isRestaurant: true,
    cuisine: 'Brunch', price: 2,
    meals: ['breakfast', 'brunch', 'lunch'],
    vibe: ['iconic', 'casual', 'family_friendly'],
    dietary: ['vegetarian'], // latkes, blintzes, egg dishes — easy meatless brunch
    bookingDifficulty: 'easy',
    bookingUrl: 'https://resy.com/cities/ny/russ-and-daughters-cafe',
    mustOrder: ['Classic Board (any fish)', 'Super Heebster bagel', 'Egg cream'],
  },

  katzs: {
    id: 'katzs',
    name: `Katz's Delicatessen`,
    fullName: "Katz's Delicatessen",
    neighborhood: 'Lower East Side',
    address: '205 E Houston St, New York, NY 10002',
    hours: 'Sun–Wed 8am – 10:45pm · Thu 8am – 2:30am · Fri–Sat 24 hours',
    ticketUrl: 'https://www.katzsdelicatessen.com/',
    scheduleUrl: '',
    mapUrl: "https://maps.google.com/?q=Katz's+Deli",
    imageUrl: '',
    color: '#dc2626', accentColor: '#dc2626',
    description: `Since 1888 — the pastrami on rye that's the New York deli benchmark. The "I'll have what she's having" scene was filmed at table 9.`,
    character: `Katz's Delicatessen opened in 1888 on the Lower East Side and has barely changed since. The pastrami is hand-cut to order, the rye is from Orwasher's, the brisket and corned beef are equally serious. The system is byzantine: get a ticket at the door, give it to the carver who'll hand you a sandwich and stamp the ticket, pay the cashier on the way out. Lose the ticket = $100 fine (they enforce it).`,
    specialties: ['Jewish deli', 'Pastrami', 'Iconic', 'Late night'],
    admissionCost: `$$ — pastrami on rye $26`,
    visitDuration: `45 min`,
    bookingNote: `Walk-in only. Counter line or table service (servers more expensive, faster).`,
    familyFriendly: true,
    insiderTip: `Get a ticket from the host at the door — DO NOT LOSE IT or it's $100. Go to the carver's counter (not the table-service side) and order pastrami on rye + a tip in the cup gets you an extra-thick cut. Eat at the long shared tables; table 9 is where the When Harry Met Sally scene was filmed.`,
    isRestaurant: true,
    cuisine: 'Deli', price: 2,
    meals: ['breakfast', 'lunch', 'dinner', 'late_night'],
    vibe: ['iconic', 'casual', 'family_friendly'],
    bookingDifficulty: 'walk-in',
    bookingUrl: '',
    mustOrder: ['Pastrami on rye', 'Matzo ball soup', 'Cel-Ray soda'],
  },
  ...
  veselka: {
    ...
    hours: '24/7',
    ticketUrl: 'https://veselka.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Veselka+East+Village',
    imageUrl: '',
    color: '#fbbf24', accentColor: '#fbbf24',
    description: `24-hour Ukrainian diner in the East Village since 1954 — pierogi, borscht, and a corner-of-9th-and-2nd location that hasn't changed in decades.`,
    character: `Veselka was founded in 1954 by Ukrainian immigrants Wolodymyr and Olha Darmochwal and has been on the corner of 9th Street and 2nd Avenue ever since. The pierogi are made fresh daily (boiled or fried), the borscht is the standard against which every other version in NYC is measured. Open 24 hours — the destination late-night spot when you need real food at 3am.`,
    specialties: ['Ukrainian', 'Late night', '24/7', 'Pierogi'],
    admissionCost: `$$ — $15-25/person`,
    visitDuration: `45 min`,
    bookingNote: `Walk-in only; longest waits are weekend brunch 10am-2pm.`,
    familyFriendly: true,
    insiderTip: `4am pierogi is the real Veselka move — empty dining room, freshly made, just the cooks and the hardcore. Order the pierogi sampler (potato, cheese, mushroom, sauerkraut) + cold borscht in summer or hot in winter. The challah french toast at brunch is underrated.`,
    isRestaurant: true,
    cuisine: 'Brunch', price: 2,
    meals: ['breakfast', 'brunch', 'lunch', 'dinner', 'late_night'],
    vibe: ['iconic', 'casual', 'late_night', 'family_friendly'],
    dietary: ['vegetarian'], // pierogi, potato pancakes, borscht in meatless variants
    bookingDifficulty: 'walk-in',
    bookingUrl: '',
    mustOrder: ['Pierogi sampler', 'Borscht', 'Challah french toast'],
  },

  levain_bakery: {
    id: 'levain_bakery',
    name: `Levain Bakery`,
    fullName: 'Levain Bakery',
    neighborhood: 'Upper West Side',
    address: '167 W 74th St, New York, NY 10023',
    hours: 'Daily 8am – 9pm',
    ticketUrl: 'https://www.levainbakery.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Levain+Bakery+UWS',
    imageUrl: '',
    color: '#854d0e', accentColor: '#854d0e',
    description: `The 6oz chocolate-chip walnut cookie that started the New York "thick cookie" movement. $5, warm, life-changing.`,
    character: `Pam Weekes and Connie McDonald opened Levain in 1995 in a basement on West 74th Street. The flagship product is a 6-ounce chocolate-chip walnut cookie — crusty outside, soft and underdone-by-design inside — that has become the standard for what a New York cookie should be. Lines around the block on weekends; daily lines on weekdays.`,
    specialties: ['Bakery', 'Cookies', 'Iconic', 'Walk-in'],
    admissionCost: `$ — cookies ~$5 each`,
    visitDuration: `15 min`,
    bookingNote: `Walk-in only. Multiple locations now (UWS, UES, Harlem, Williamsburg) — line length similar across all.`,
    familyFriendly: true,
    insiderTip: `Get the chocolate chip walnut (the original) — first time, do not deviate. Eat it warm immediately; reheating works (350°F for 5 min) but never matches fresh. The Williamsburg location often has shorter lines than UWS.`,
    isRestaurant: true,
    cuisine: 'Bakery', price: 1,
    meals: ['breakfast', 'brunch', 'lunch'],
    vibe: ['iconic', 'casual', 'quick', 'family_friendly'],
    dietary: ['vegetarian'],
    bookingDifficulty: 'walk-in',
    bookingUrl: '',
    mustOrder: ['Chocolate chip walnut cookie', 'Dark chocolate peanut butter chip', 'Two chip chocolate chip'],
  },

  eleven_madison_park: {
    id: 'eleven_madison_park',
    name: `Eleven Madison Park`,
    fullName: 'Eleven Madison Park',
    neighborhood: 'Flatiron',
    address: '11 Madison Ave, New York, NY 10010',
    hours: 'Tue–Sat 5pm – 10pm · Closed Sun–Mon',
    ticketUrl: 'https://www.elevenmadisonpark.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Eleven+Madison+Park',
    imageUrl: '',
    color: '#14532d', accentColor: '#14532d',
    description: `Daniel Humm's three-Michelin-star tasting menu — went fully plant-based in 2021, the most-discussed pivot in NYC fine dining.`,
    character: `Eleven Madison Park opened in 1998 inside the Art Deco Metropolitan Life North Building. Daniel Humm took over in 2006 and elevated it to three Michelin stars and a #1 World's 50 Best ranking in 2017. In 2021 the restaurant relaunched fully plant-based — the most-debated decision in NYC fine dining history. The dining room is one of the most beautiful in America; the experience is theatrical.`,
    specialties: ['Plant-based', 'Tasting menu', 'Splurge', 'Three Michelin stars'],
    admissionCost: `$$$$ — $365/person tasting menu`,
    visitDuration: `3+ hours`,
    bookingNote: `Tock reservations release every Monday at noon ET for the upcoming month; sell out within minutes.`,
    familyFriendly: false,
    insiderTip: `If the main tasting is out of reach (price or booking), the Bar Room next door has a partial menu at half the price with walk-in availability some nights. The architecture alone is worth the visit — request a window seat for the Madison Square Park views.`,
    isRestaurant: true,
    cuisine: 'Modern American (vegan)', price: 4,
    meals: ['dinner'],
    vibe: ['splurge', 'iconic', 'date_night'],
    dietary: ['vegan', 'vegetarian', 'gluten_free'], // fully plant-based menu since 2021
    bookingDifficulty: 'impossible',
    bookingUrl: 'https://www.exploretock.com/elevenmadisonpark',
    mustOrder: ['Tasting menu (no other options)'],
  },

  roberta_s_pizza: {
    id: 'roberta_s_pizza',
    name: `Roberta's`,
    fullName: "Roberta's Pizza",
    neighborhood: 'Bushwick',
    address: '261 Moore St, Brooklyn, NY 11206',
    hours: 'Daily 11am – midnight',
    ticketUrl: 'https://www.robertaspizza.com/',
    scheduleUrl: '',
    mapUrl: "https://maps.google.com/?q=Roberta's+Pizza+Bushwick",
    imageUrl: '',
    color: '#dc2626', accentColor: '#dc2626',
    description: `Wood-fired pizza in a Bushwick shipping-container compound — the Bee Sting (honey + chili + soppressata) is the pie that defined a generation.`,
    character: `Roberta's opened in a converted warehouse in Bushwick in 2008 and helped invent the modern Brooklyn restaurant aesthetic — repurposed industrial space, hyper-local sourcing, wood-fired everything. The Bee Sting (tomato, mozzarella, soppressata, chili, honey) is the dish that broke through. Sister restaurant Blanca next door has two Michelin stars; the pizzeria itself is no-reservations casual.`,
    specialties: ['Wood-fired pizza', 'Brooklyn', 'Walk-in'],
    admissionCost: `$$ — pizzas $18-28`,
    visitDuration: `1.5 hours`,
    bookingNote: `Walk-in only at the main counter. The two-Michelin-star tasting Blanca next door is a separate booking.`,
    familyFriendly: true,
    insiderTip: `Order the Bee Sting (the must-try) plus one rotating special. The back patio (open seasonally) is the move on a warm night. If you can score Blanca's tasting menu next door, do it — completely separate experience.`,
    isRestaurant: true,
    cuisine: 'Pizza', price: 2,
    meals: ['lunch', 'dinner'],
    vibe: ['iconic', 'casual', 'family_friendly'],
    dietary: ['vegetarian', 'vegan'], // known for vegan pies alongside the classics
    bookingDifficulty: 'easy',
    bookingUrl: '',
    mustOrder: ['Bee Sting pizza', 'Margherita classica', 'Anything off the seasonal specials board'],
  },
  ...
  atoboy: {
    ...
    hours: 'Mon–Sat 5:30pm – 10pm · Closed Sun',
    ticketUrl: 'https://atoboynyc.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Atoboy+NYC',
    imageUrl: '',
    color: '#a16207', accentColor: '#a16207',
    description: `The accessible sibling of three-Michelin-star Atomix — modern Korean small plates from the same chef at a fraction of the price.`,
    character: `Chef Junghyun Park opened Atoboy in 2016 (two years before Atomix) and proved the modern-Korean format would work in New York. Three- or four-course prix fixe — pick a protein, a vegetable, a noodle/rice — each course made up of three small plates. The dining room is minimal and bright; the food is precise and balanced.`,
    specialties: ['Korean', 'Modern', 'Small plates'],
    admissionCost: `$$$ — $75/person prix fixe`,
    visitDuration: `2 hours`,
    bookingNote: `Resy 30 days out; usually available on weeknights. Walk-in at the bar.`,
    familyFriendly: true,
    insiderTip: `If you can't get into Atomix, this is the move — same chef, same precision, $295 less per person. Order the four-course (worth the $20 upgrade over three) and make sure one of your picks is the soy-marinated crab. Walk-in works most weeknights.`,
    isRestaurant: true,
    cuisine: 'Korean', price: 3,
    meals: ['dinner'],
    vibe: ['date_night', 'modern'],
    dietary: ['vegetarian'], // vegetable-forward banchan format adapts well
    bookingDifficulty: 'easy',
    bookingUrl: 'https://resy.com/cities/ny/atoboy',
    mustOrder: ['Soy-marinated crab', 'Beef tartare', 'Anything from the noodle course'],
  },
  ...
  death_and_co: {
    ...
    hours: 'Daily 6pm – 1am',
    ticketUrl: 'https://www.deathandcompany.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Death+and+Co+New+York',
    imageUrl: '',
    color: '#1c1917',
    accentColor: '#f59e0b',
    description: `The cocktail bar that single-handedly invented the modern American craft cocktail movement when it opened in 2006.`,
    character: `Death & Co opened on a quiet East Village block in 2006 and is widely credited as the bar that launched the modern American cocktail renaissance. The room is dark, the playlist is curated, the menu (now in its 3rd published book) is dense with original cocktails that have been borrowed by every craft bar in America since. No standing — you wait for a table.`,
    specialties: ['Craft cocktails', 'Date night', 'Hidden gem'],
    admissionCost: `Cocktails $19–22`,
    visitDuration: `1–2 hours`,
    bookingNote: `Reservations on Resy or walk-in (host will text you when a table opens — leave and come back).`,
    familyFriendly: false,
    insiderTip: `If the wait is over an hour, walk one block to Mace (sister bar across the street) — same caliber, easier to get into. Ask the bartender for "something based on [spirit] that I haven't had before" and trust them.`,
    isRestaurant: true,
    cuisine: 'Bar', price: 3,
    meals: ['dinner', 'late_night'],
    vibe: ['date_night', 'iconic', 'hidden_gem'],
    ...
    mustOrder: ['Anything bartender\'s-choice', 'Naked & Famous'],
  },
  ...
  ny_aquarium: {
    ...
    fullName: 'New York Aquarium at Coney Island',
    neighborhood: 'Coney Island',
    address: '602 Surf Ave, Brooklyn, NY 11224',
    hours: 'Daily 10am – 4:30pm (seasonal hours vary)',
    ticketUrl: 'https://nyaquarium.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=NY+Aquarium+Coney+Island',
    imageUrl: '',
    color: '#0369a1',
    accentColor: '#0369a1',
    description: `Wildlife Conservation Society's oceanfront aquarium on the Coney Island boardwalk — sharks, sea lions, the city's only public coral reef tank.`,
    character: `The NY Aquarium has been on the Coney Island boardwalk since 1957, holding 350+ species across 8 main exhibit halls. The Ocean Wonders: Sharks! pavilion (added 2018) is the headline — a 500,000-gallon shark tank with floor-to-ceiling viewing. The sea lion show in the central courtyard is a kid magnet. Combine the aquarium with a Coney Island boardwalk + Wonder Wheel afternoon for one of the best low-cost family days in NYC.`,
    specialties: ['Aquarium', 'Family-friendly', 'Wildlife'],
    admissionCost: `$30 adults · $25 children · pay-what-you-wish Wed 3pm–close`,
    visitDuration: `2–3 hours`,
    bookingNote: `Walk-up or online; weekend afternoons get busy`,
    familyFriendly: true,
    insiderTip: `Wednesday afternoons (3pm to close) are pay-what-you-wish. Pair with a Wonder Wheel ride next door and a Nathan's hot dog for the full Coney Island day — total under $40 for a family of four if you time the aquarium right.`,
  },

  brooklyn_childrens_museum: {
    id: 'brooklyn_childrens_museum',
    name: `Brooklyn Children's Museum`,
    fullName: "Brooklyn Children's Museum",
    neighborhood: 'Crown Heights',
    address: '145 Brooklyn Ave, Brooklyn, NY 11213',
    hours: 'Tue–Sun 10am – 5pm · Closed Mon',
    ticketUrl: 'https://www.brooklynkids.org/',
    scheduleUrl: '',
    mapUrl: "https://maps.google.com/?q=Brooklyn+Childrens+Museum",
    imageUrl: '',
    color: '#dc2626',
    accentColor: '#dc2626',
    description: `The world's first museum designed specifically for children, founded in 1899 — bright yellow building in Crown Heights packed with hands-on exhibits.`,
    character: `Founded in 1899, Brooklyn Children's Museum is the world's oldest children's museum and still one of the best. The current Rafael Viñoly-designed building (2008) is a bright yellow icon of Crown Heights, with four floors of hands-on exhibits aimed squarely at ages 2–10. Standouts: the World Brooklyn neighborhood exhibit (kids 'shop' in mini bodegas and restaurants), the sand-water-pulley room, the rooftop garden. Free First Thursdays.`,
    specialties: ['Children\'s museum', 'Family-friendly', 'Hands-on exhibits'],
    admissionCost: `$15 · Free First Thursdays (4–8pm)`,
    visitDuration: `2–3 hours`,
    bookingNote: `Walk-up; weekends + school holidays crowded`,
    familyFriendly: true,
    insiderTip: `First Thursday of every month is free 4–8pm — go after school. Designed for ages 2–10; older kids will get bored, but younger siblings hit the sweet spot.`,
  },

  // ── Rainy-day indoor anchors ──
  chelsea_market: {
    id: 'chelsea_market',
    name: `Chelsea Market`,
    ...
    ticketUrl: 'https://www.chelseamarket.com/',
    scheduleUrl: '',
    mapUrl: 'https://maps.google.com/?q=Chelsea+Market+New+York',
    imageUrl: '',
    color: '#7c2d12',
    accentColor: '#7c2d12',
    description: `Indoor food + shopping market in the former Nabisco factory — 35+ vendors across a full city block. The canonical NYC rainy-day destination.`,
    character: `Chelsea Market occupies the entire ground floor of the former National Biscuit Company factory (where the Oreo was invented in 1912) and runs a full block between 9th and 10th Avenues. Lobster rolls at Lobster Place, tacos at Los Tacos No. 1, donuts at Doughnuttery, oysters at Cull & Pistol — 35+ food vendors plus boutiques, bookshops, and a basement of artisan shops. Connect directly to the High Line via the elevator at the 10th Ave side.`,
    specialties: ['Indoor market', 'Food hall', 'Rainy day', 'High Line connection'],
    admissionCost: `Free entry · pay per vendor ($5–25 per dish)`,
    visitDuration: `1–2 hours`,
    bookingNote: `Walk-in`,
    familyFriendly: true,
    insiderTip: `Los Tacos No. 1 (the original) has the longest line for a reason — order the adobada. Lobster Place has the actual best lobster roll in the city for under $30. Both can be eaten standing at the bar counters if all the central seating is full.`,
  },

  angelika_film_center: {
    id: 'angelika_film_center',
    name: `Angelika Film Center`,
    fullName: 'Angelika Film Center',
    neighborhood: 'NoHo',
    address: '18 W Houston St, New York, NY 10012',
    hours: 'Daily 11am – midnight',
    ticketUrl: 'https://www.angelikafilmcenter.com/nyc',
    scheduleUrl: 'https://www.angelikafilmcenter.com/nyc',
    mapUrl: 'https://maps.google.com/?q=Angelika+Film+Center+NYC',
    imageUrl: '',
    color: '#7c3aed',
    accentColor: '#7c3aed',
    description: `Six-screen indie cinema on Houston Street since 1989 — the New York home for foreign films, documentaries, and indie premieres that don't make it to chain multiplexes.`,
    character: `The Angelika has six screens in a converted Cable Building basement on Houston, with a glass-fronted cafe at street level. Since 1989 it's been NYC's main commercial home for foreign-language films, indie premieres, and documentaries that wouldn't get bookings at the AMC. The seats rumble slightly because the 6 train runs directly under the building — locals consider it part of the experience.`,
    specialties: ['Indie cinema', 'Foreign films', 'Documentaries', 'Rainy day'],
    admissionCost: `$18 adults · $14 matinee`,
    visitDuration: `2–3 hours`,
    bookingNote: `Buy online for popular new releases; walk-up usually fine weekdays`,
    familyFriendly: true,
    insiderTip: `Yes, you can feel the subway rumble during quiet scenes — it's part of the experience, not a flaw. Best seats are middle-to-back of the screening rooms (the front rows feel more train-shake). The cafe upstairs serves espresso + pastries before the film.`,
  },

  // ── First-time canonical hits ──
  times_square: {
    id: 'times_square',
    name: `Times Square`,
    fullName: 'Times Square',
    neighborhood: 'Midtown',
    address: 'Broadway & 7th Ave between 42nd & 47th St, New York, NY',
    hours: '24/7',
    ticketUrl: '',
    scheduleUrl: '',
    ...
    color: '#dc2626',
    accentColor: '#dc2626',
    description: `Yes it's a tourist trap. It's also the most photographed intersection on Earth — 50 million visitors a year and the closest thing the world has to a public living room.`,
    character: `Times Square was a horse-trading market called Longacre Square until 1904, when the NY Times moved its HQ to the triangular building at 42nd Street and the city renamed the whole intersection after the paper. Today it's lit by 250,000 LED billboards covering ~290,000 square feet of digital signage — a single 30-second ad slot on the largest screen rents for $25,000. Locals avoid it. Tourists love it. Both reactions are correct.`,
    specialties: ['Iconic landmark', 'First-time NYC', 'People-watching', 'Photography'],
    admissionCost: `Free`,
    visitDuration: `30 min – 1 hour`,
    bookingNote: `Walk-in 24/7`,
    familyFriendly: true,
    insiderTip: `Stand on the red steps above the TKTS booth (47th St) for the elevated view that's in every Instagram photo. Go between 8pm–10pm for peak neon brightness; before sunrise for the surreal empty-version most tourists never see. Don't bother with the costumed characters — they aggressively demand tips and there are better photos one block in any direction.`,
  },
  ...
  statue_of_liberty: {
    ...
    hours: 'Daily 9am – 4pm (last ferry 3:30pm)',
    ...
    color: '#14532d',
    accentColor: '#14532d',
    description: `Bartholdi's 1886 colossus — France's gift to America for the 100th anniversary of the Declaration of Independence. A 305-foot copper figure on a star-shaped pedestal in New York Harbor.`,
    character: `The Statue of Liberty was designed by Frédéric Auguste Bartholdi with an internal iron framework by Gustave Eiffel (yes, that Eiffel) and gifted by France to the U.S. in 1886. The 305-foot copper figure was originally the brown of new copper; the green patina is oxidation that developed over the first 30 years. The pedestal alone is 154 feet. Ferries from Battery Park (Manhattan) or Liberty State Park (NJ) include Liberty + Ellis Island; "crown access" tickets sell out months ahead.`,
    specialties: ['National monument', 'First-time NYC', 'American history'],
    admissionCost: `$24 ferry (includes Liberty + Ellis) · Crown access $24 + advance booking`,
    visitDuration: `4–5 hours (round trip including Ellis Island)`,
    bookingNote: `Book ferries at statuecruises.com 1–2 weeks ahead; crown access 3+ months ahead`,
    familyFriendly: true,
    insiderTip: `The free Staten Island Ferry from Whitehall Terminal gives you a perfectly good view of the Statue from the water at zero cost — if you don't need to physically set foot on Liberty Island, take the SI ferry instead and save the $24. If you DO board the island, allocate the full day for Liberty + Ellis Island together (they're sold as a combined ticket).`,
  },
  ...
  staten_island_ferry_terminal: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Staten_Island_Ferry_Barberi.jpg/500px-Staten_Island_Ferry_Barberi.jpg',
    color: '#fff7ed',
    accentColor: '#ea580c',
...
export const works = {
  ...
  leger_smoker: {
    ...
    dimensions: '51¼ × 38¼ in',
    imageCredit: 'Wikimedia Commons / Public Domain',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Le_Soldat_%C3%A0_la_pipe_-_Fernand_L%C3%A9ger.jpg/330px-Le_Soldat_%C3%A0_la_pipe_-_Fernand_L%C3%A9ger.jpg',
    whatToLookFor: [
...
Patterson later became a goodwill ambassador for boxing, an articulate advocate for the sport that had made him, and a complicated figure in the sport's history: supremely talented, often self-critical, and honest in a way that the boxing world rarely rewards.`,
  ...
  rockefeller_sunken_plaza: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Rockefeller_Center_Lower_Plaza_New_York_City_2022.jpg/330px-Rockefeller_Center_Lower_Plaza_New_York_City_2022.jpg',
  ...
  woolworth_lobby: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Lobby_Woolworth_Building_New_York_City_June_2019.jpg/330px-Lobby_Woolworth_Building_New_York_City_June_2019.jpg',
  ...
  nypl_rose_reading_room: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Catullus_Books_NYPL_Rose_Main_Reading_Room.jpg/330px-Catullus_Books_NYPL_Rose_Main_Reading_Room.jpg',
  ...
  nypl_facade_lions: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/New_York_Public_Library_Main_Branch_Lion.jpg/330px-New_York_Public_Library_Main_Branch_Lion.jpg',
  ...
  oklahoma_1943: {
    ...
    year: `1943`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Oklahoma_8e07916v.jpg/500px-Oklahoma_8e07916v.jpg',
  ...
  south_pacific_1949: {
    ...
    year: `1949`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/South_Pacific_Playbill.jpg/500px-South_Pacific_Playbill.jpg',
  ...
  company_1970: {
    ...
    year: `1970`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Company_%28musical%29_1971_still.jpg/500px-Company_%28musical%29_1971_still.jpg',
  ...
  carousel_1945: {
    ...
    year: `1945`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Carousel_Cast_%286872288522%29.jpg/500px-Carousel_Cast_%286872288522%29.jpg',
  ...
  gypsy_1959: {
    ...
    year: `1959`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Gypsy_2012_%287706759598%29.jpg/500px-Gypsy_2012_%287706759598%29.jpg',
  ...
  hamilton_2015: {
    ...
    year: `2015`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Lin-Manuel_Miranda%2C_Phillipa_Soo%2C_Leslie_Odom%2C_Jr.%2C_and_Christopher_Jackson%2C_White_House%2C_March_2016.jpg/500px-Lin-Manuel_Miranda%2C_Phillipa_Soo%2C_Leslie_Odom%2C_Jr.%2C_and_Christopher_Jackson%2C_White_House%2C_March_2016.jpg',
  ...
  in_the_heights_public: {
    ...
    figureId: 'lin_manuel_miranda',
    topicId: 'theater_off_broadway',
    title: `In the Heights (Workshop)`,
    year: `2007`,
    medium: `Musical (Workshop)`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/In_the_heights_%284330087779%29.jpg/500px-In_the_heights_%284330087779%29.jpg',
  ...
  death_salesman_revival: {
    ...
    year: `1949`,
    medium: `Play`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Death_of_a_Salesman_Lee_J._Cobb_1966.jpg/500px-Death_of_a_Salesman_Lee_J._Cobb_1966.jpg',
  ...
  streetcar_1947: {
    ...
    year: `1947`,
    medium: `Play`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Jessica_Tandy_with_Kim_Hunter_and_Marlon_Brando._cph.3b23243.II.jpg/500px-Jessica_Tandy_with_Kim_Hunter_and_Marlon_Brando._cph.3b23243.II.jpg',
  ...
  fences_1987: {
    ...
    year: `1987`,
    medium: `Play`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/August_Wilson_Theatre_NYC.jpg/500px-August_Wilson_Theatre_NYC.jpg',
  ...
  raisin_in_sun_1959: {
    ...
    year: `1959`,
    medium: `Play`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/A_Raisin_in_the_Sun_1959_2.JPG/500px-A_Raisin_in_the_Sun_1959_2.JPG',
  ...
  // ── CURRENT BLOCKBUSTER MUSICALS ────────────────────────────────────────
  // The shows tourists actually fly in for. Each is the long-running tenant
  // of its theater — Wicked at the Gershwin, Lion King at the Minskoff, etc.
  // No figureId on most of these — their creators (Stephen Schwartz, Trey
  // Parker, Elton John, Alan Menken) aren't in our figures table yet, but
  // the works still surface via the new venueId-based theaterShows query.
  wicked_2003: {
    id: 'wicked_2003',
    venueId: 'gershwin_theatre',
    figureId: '',
    topicId: 'theater_musicals',
    title: `Wicked`,
    year: `2003`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Gershwin_Theatre_-_Wicked_%2854077363135%29.jpg/500px-Gershwin_Theatre_-_Wicked_%2854077363135%29.jpg',
    description: `Wicked opened at the Gershwin Theatre on October 30, 2003. Stephen Schwartz's musical, based on Gregory Maguire's 1995 novel, retells The Wizard of Oz from the witches' point of view. It has become the second-longest-running Broadway show in history and routinely grosses more per week than any production except The Lion King.`,
    significance: `Wicked is the defining commercial blockbuster of 21st-century Broadway — a literary-source musical that fused fantasy worldbuilding with showtune emotional ambition, and proved that the form could sustain decade-long runs in the post-Phantom era.`,
    currentlyRunning: true,
  },
  lion_king_1997: {
    id: 'lion_king_1997',
    venueId: 'minskoff_theatre',
    figureId: '',
    topicId: 'theater_musicals',
    title: `The Lion King`,
    year: `1997`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Minskoff_Theatre_%2854076031902%29.jpg/500px-Minskoff_Theatre_%2854076031902%29.jpg',
    description: `Disney's The Lion King opened at the New Amsterdam on November 13, 1997 and moved to the Minskoff in 2006. Julie Taymor's puppetry — the giraffes on stilts, the elephant processing down the aisle in the opening "Circle of Life" — won her the first Best Direction Tony awarded to a woman. The production has now grossed more than any other show in Broadway history.`,
    significance: `The Lion King reset the bar for Broadway visual ambition and demonstrated that family-targeted musicals could be both artistically serious and commercially dominant. Taymor's puppetry became the most-imitated stagecraft of the past three decades.`,
    currentlyRunning: true,
  },
  chicago_1996: {
    id: 'chicago_1996',
    venueId: 'ambassador_theatre',
    figureId: '',
    topicId: 'theater_musicals',
    title: `Chicago`,
    year: `1996`,
    medium: `Musical (Revival)`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Ambassador_Theatre_-_Chicago_%2848296059772%29.jpg/500px-Ambassador_Theatre_-_Chicago_%2848296059772%29.jpg',
    description: `The current revival of Chicago opened November 14, 1996 at the Richard Rodgers, transferred to the Shubert in 1997, and has played the Ambassador since 2003. The Bob Fosse / John Kander / Fred Ebb 1975 musical's deliberately minimalist staging — band onstage, dancers in black — has barely changed in nearly thirty years. It is the longest-running American musical in Broadway history.`,
    significance: `The Chicago revival proved that stripped-down staging could outlast spectacle. By keeping the design constant and rotating in celebrity casting, the production has stayed culturally alive while almost every other show that opened in 1996 closed within a decade.`,
    currentlyRunning: true,
  },
  harry_potter_cursed_child_2018: {
    id: 'harry_potter_cursed_child_2018',
    venueId: 'lyric_theatre',
    figureId: '',
    // Technically a Play, not a Musical — but the Musicals topic now serves
    // as the "big Broadway shows tourists know" bucket (Wicked, Lion King,
    // Hamilton, etc.) and Cursed Child belongs there, not in the Miller /
    // Williams / Wilson Drama canon.
    topicId: 'theater_musicals',
    title: `Harry Potter and the Cursed Child`,
    year: `2018`,
    medium: `Play`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Lyric_Theatre_-_Harry_Potter_and_the_Cursed_Child_%2848193409386%29.jpg/500px-Lyric_Theatre_-_Harry_Potter_and_the_Cursed_Child_%2848193409386%29.jpg',
    description: `Jack Thorne's two-part play opened at the Lyric Theatre on April 22, 2018 after a year-long retrofit of the building. The eighth Harry Potter story, set nineteen years after the Battle of Hogwarts, features the most ambitious stage illusions on Broadway — patronuses, polyjuice transformations, characters appearing inside walls. Condensed to a single evening in 2021.`,
    significance: `Cursed Child made stage magic respectable as a primary medium of Broadway storytelling. The technical innovations (custom-built smoke turbines, an entire bookcase that swallows actors) have been studied by every illusion-heavy production since.`,
    currentlyRunning: true,
  },
  back_to_the_future_2023: {
    id: 'back_to_the_future_2023',
    venueId: 'winter_garden_theatre',
    figureId: '',
    topicId: 'theater_musicals',
    title: `Back to the Future: The Musical`,
    year: `2023`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Back_To_the_Future-_The_Musical_at_the_Winter_Garden_Theatre%2C_August_2023%2C_night.jpg/500px-Back_To_the_Future-_The_Musical_at_the_Winter_Garden_Theatre%2C_August_2023%2C_night.jpg',
    description: `Back to the Future: The Musical opened at the Winter Garden on August 3, 2023 with book by Bob Gale, the original screenwriter. Alan Silvestri and Glen Ballard wrote the original score; the show retains "The Power of Love" and "Johnny B. Goode" from the film. The centerpiece illusion is a working flying DeLorean that traverses the audience.`,
    significance: `Back to the Future demonstrated that the film-to-stage adaptation pipeline — once dismissed as cynical IP harvesting — could produce visually inventive original stagecraft, particularly in the DeLorean sequences.`,
    currentlyRunning: true,
  },
  book_of_mormon_2011: {
    id: 'book_of_mormon_2011',
    venueId: 'eugene_oneill_theatre',
    figureId: '',
    topicId: 'theater_musicals',
    title: `The Book of Mormon`,
    year: `2011`,
    medium: `Musical`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Book_of_Mormon_%40_Eugene_ONeill_Theatre_on_Broadway.jpg/500px-Book_of_Mormon_%40_Eugene_ONeill_Theatre_on_Broadway.jpg',
    description: `Trey Parker, Matt Stone, and Robert Lopez's musical opened at the Eugene O'Neill on March 24, 2011 and won nine Tony Awards including Best Musical. The South Park creators' satire of religious certainty — wrapped in genuine affection for the people who hold it — became one of the most critically beloved comedies in Broadway history.`,
    significance: `The Book of Mormon proved that contemporary comedy musicals could be both Tony-Award serious and tourist-magnet popular. Its commercial endurance (14+ years and counting) and its sustained ability to attract a younger audience reset assumptions about what counts as a long-runner.`,
    currentlyRunning: true,
  },
  ...
  how_the_other_half_lives_1890: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Jacob_Riis_2.jpg/500px-Jacob_Riis_2.jpg',
  ...
  chisholm_1972_campaign: {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Shirley_Chisholm.jpg/500px-Shirley_Chisholm.jpg',
...
He was thoughtful and introspective in a way unusual for boxing champions — he wrote, he reflected, he second-guessed himself publicly. He served on the New York State Athletic Commission after retirement. D'Amato\'s methods traveled from Patterson to Tyson: the lineage runs through New York.`,
  ...
  william_van_alen: {
    ...
    nationality: `American`,
    years: `1883–1954`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/William_Van_Alen_%281883%E2%80%931954%29.png/500px-William_Van_Alen_%281883%E2%80%931954%29.png',
  ...
  raymond_hood: {
    ...
    nationality: `American`,
    years: `1881–1934`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Raymond_M._Hood%2C_1923.jpg/500px-Raymond_M._Hood%2C_1923.jpg',
  ...
  cass_gilbert: {
    ...
    nationality: `American`,
    years: `1859–1934`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Cass_Gilbert_1907.jpg/500px-Cass_Gilbert_1907.jpg',
  ...
  john_roebling: {
    ...
    years: `1806–1869`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Brooklyn_Museum_-_John_Augustus_Roebling.jpg/500px-Brooklyn_Museum_-_John_Augustus_Roebling.jpg',
  ...
  whitney_warren: {
    ...
    nationality: `American`,
    years: `1864–1943`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Whitney_Warren_1915_%28cropped%29.jpg/500px-Whitney_Warren_1915_%28cropped%29.jpg',
  ...
  john_carrere: {
    ...
    nationality: `American`,
    years: `1858–1911`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/John_Merven_Carr%C3%A8re.jpg/500px-John_Merven_Carr%C3%A8re.jpg',
  ...
  daniel_burnham: {
    ...
    nationality: `American`,
    years: `1846–1912`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Daniel_Hudson_Burnham.png/500px-Daniel_Hudson_Burnham.png',
  ...
  mies_van_der_rohe: {
    ...
    nationality: `German-American`,
    years: `1886–1969`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Ludwig_Mies_van_der_Rohe_in_Arts_%26_Architecture%2C_June_1960_issue.jpg/500px-Ludwig_Mies_van_der_Rohe_in_Arts_%26_Architecture%2C_June_1960_issue.jpg',
  ...
  elizabeth_diller: {
    ...
    nationality: `American`,
    years: `1954–`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Elizabeth_Diller_-_2016_%28cropped%29.jpg/500px-Elizabeth_Diller_-_2016_%28cropped%29.jpg',
  ...
  richard_rodgers: {
    ...
    nationality: `American`,
    years: `1902–1979`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Rodgers.jpg/500px-Rodgers.jpg',
  ...
  lin_manuel_miranda: {
    ...
    nationality: `American`,
    years: `1980–`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Lin-Manuel_Miranda_%26_James_McAvoy_%2848383681926%29_%28cropped%29.jpg/500px-Lin-Manuel_Miranda_%26_James_McAvoy_%2848383681926%29_%28cropped%29.jpg',
  ...
  arthur_miller: {
    ...
    nationality: `American`,
    years: `1915–2005`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Arthur_Miller_1966.jpg/500px-Arthur_Miller_1966.jpg',
  ...
  tennessee_williams: {
    ...
    nationality: `American`,
    years: `1911–1983`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Tennessee_Williams_NYWTS.jpg/500px-Tennessee_Williams_NYWTS.jpg',
  ...
  august_wilson: {
    ...
    nationality: `American`,
    years: `1945–2005`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/August_Wilson_1990_%28cropped%29.jpg/500px-August_Wilson_1990_%28cropped%29.jpg',
  ...
  george_washington: {
    ...
    nationality: `American`,
    years: `1732–1799`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Gilbert_Stuart_Williamstown_Portrait_of_George_Washington.jpg/500px-Gilbert_Stuart_Williamstown_Portrait_of_George_Washington.jpg',
  ...
  alexander_hamilton: {
    ...
    years: `1755–1804`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/John_Trumbull_-_Alexander_Hamilton_-_Google_Art_Project.jpg/500px-John_Trumbull_-_Alexander_Hamilton_-_Google_Art_Project.jpg',
  ...
  frederick_douglass: {
    ...
    nationality: `American`,
    years: `1818–1895`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Frederick_Douglass_%28circa_1879%29_%28cropped%29.jpg/500px-Frederick_Douglass_%28circa_1879%29_%28cropped%29.jpg',
  ...
  emma_goldman: {
    ...
    nationality: `Russian-American`,
    years: `1869–1940`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Emma_Goldman_seated.jpg/500px-Emma_Goldman_seated.jpg',
  ...
  marsha_p_johnson: {
    ...
    nationality: `American`,
    years: `1945–1992`,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Marsha_P._Johnson.jpg/500px-Marsha_P._Johnson.jpg',
...
Boxing in New York has always been tied to the city's character. The fighters who trained in New York gyms represented neighborhoods and backgrounds that made each fight legible as something more than athletic competition. The tradition continues at both MSG and Barclays Center.`,
  ...
  theater_musicals: {
    ...
    // Blockbuster long-runners listed first so the most-searched shows (Wicked,
    // Lion King, Chicago, etc.) sit at the top of the theater list. Historic
    // and revival-heavy houses follow.
    venueIds: [
      'gershwin_theatre',          // Wicked
      'minskoff_theatre',          // The Lion King
      'ambassador_theatre',        // Chicago
      'lyric_theatre',             // Harry Potter and the Cursed Child
      'winter_garden_theatre',     // Back to the Future
      'eugene_oneill_theatre',     // The Book of Mormon
      'richard_rodgers_theatre',   // Hamilton
      'majestic_theatre',
      'st_james_theatre',
      'imperial_theatre',
      'shubert_theatre',
...
export function getSeeAlsoNearby(workId) {
  ...
  if (!w) return { otherByFigure: [], otherAtVenue: [], otherInTopic: [], otherFigures: [], figure: null, isJazz: false }
  // Works without a figureId (new blockbuster musicals — Wicked, Lion King,
  // Cursed Child, etc.) can't traverse figure → topic. We still return useful
  // see-also data via "Also at this venue" so the related-shows row works.
  const fig = w.figureId ? figures[w.figureId] : null
  const topic = fig ? topics[fig.topicId] : null
  const isJazz = topic?.domainId === 'jazz'
  const otherByFigure = w.figureId
    ? getWorksByFigure(w.figureId).filter(x => x.id !== workId)
    : []
  const otherFigures = topic
    ? (topic.figureIds || []).filter(id => id !== w.figureId).map(id => figures[id]).filter(Boolean)
    : []
  if (isJazz) {
    ...
    const otherAtVenue = w.venueId
      ? getWorksAtVenue(w.venueId).filter(x => x.id !== workId)
      : []
