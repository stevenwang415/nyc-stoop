...
export const venueCoords = {
  ...
  // V2 mood-feedback batch
  carbone:                    { lat: 40.7287, lng: -74.0023, domain: 'visual_art',   address: '181 Thompson St, New York, NY' },
  don_angie:                  { lat: 40.7355, lng: -74.0042, domain: 'visual_art',   address: '103 Greenwich Ave, New York, NY' },
  ...
  // Eat-mood restaurant database
  joes_pizza:                 { lat: 40.7307, lng: -74.0030, domain: 'visual_art',   address: '7 Carmine St, New York, NY' },
  lucali:                     { lat: 40.6815, lng: -74.0009, domain: 'visual_art',   address: '575 Henry St, Brooklyn, NY' },
  lilia:                      { lat: 40.7177, lng: -73.9510, domain: 'visual_art',   address: '567 Union Ave, Brooklyn, NY' },
  sushi_nakazawa:             { lat: 40.7314, lng: -74.0049, domain: 'visual_art',   address: '23 Commerce St, New York, NY' },
  atomix:                     { lat: 40.7443, lng: -73.9826, domain: 'visual_art',   address: '104 E 30th St, New York, NY' },
  peter_luger:                { lat: 40.7099, lng: -73.9624, domain: 'visual_art',   address: '178 Broadway, Brooklyn, NY' },
  le_bernardin:               { lat: 40.7610, lng: -73.9818, domain: 'visual_art',   address: '155 W 51st St, New York, NY' },
  cosme:                      { lat: 40.7392, lng: -73.9882, domain: 'visual_art',   address: '35 E 21st St, New York, NY' },
  russ_and_daughters_cafe:    { lat: 40.7211, lng: -73.9890, domain: 'visual_art',   address: '127 Orchard St, New York, NY' },
  katzs:                      { lat: 40.7223, lng: -73.9874, domain: 'visual_art',   address: '205 E Houston St, New York, NY' },
  veselka:                    { lat: 40.7287, lng: -73.9877, domain: 'visual_art',   address: '144 2nd Ave, New York, NY' },
  levain_bakery:              { lat: 40.7795, lng: -73.9794, domain: 'visual_art',   address: '167 W 74th St, New York, NY' },
  eleven_madison_park:        { lat: 40.7416, lng: -73.9874, domain: 'visual_art',   address: '11 Madison Ave, New York, NY' },
  roberta_s_pizza:            { lat: 40.7053, lng: -73.9337, domain: 'visual_art',   address: '261 Moore St, Brooklyn, NY' },
  atoboy:                     { lat: 40.7444, lng: -73.9839, domain: 'visual_art',   address: '43 E 28th St, New York, NY' },
}
